...
bool CScene::OnProcessingKeyboardMessage(HWND hWnd, UINT nMessageID, WPARAM wParam, LPARAM lParam)
{
	...
	case WM_KEYDOWN:
		switch (wParam)
		{
		case 'W': m_ppGameObjects[0]->MoveForward(-MovingSpeed); break;
		case 'S': m_ppGameObjects[0]->MoveForward(MovingSpeed); break;
		case 'A': m_ppGameObjects[0]->MoveStrafe(MovingSpeed); break;
		case 'D': m_ppGameObjects[0]->MoveStrafe(-MovingSpeed); break;
		case 'Q': m_ppGameObjects[0]->MoveUp(+MovingSpeed); break;
		case 'R': m_ppGameObjects[0]->MoveUp(-MovingSpeed); break;
		default:
			break;
		}
		break;
