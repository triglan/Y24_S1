...
{
	//cout << "* m_ppd3dPipelineStates : " << *m_ppd3dPipelineStates << endl;// 0000000000000000	000001FFCDCE00B0
	//cout << "m_ppd3dPipelineStates : " << m_ppd3dPipelineStates << endl;// 00000262CC50BC70	000001FFC7799AA0
	//cout << "pd3dCommandList : " << pd3dCommandList << endl;// 00000262CE034110	000001FFC77F3F50
	//cout << "m_nPipelineStates : " << m_nPipelineStates << endl;//1	0
...
{
	//m_ppObjects[0]->SetPosition(getPosition());
}
...
D3D12_INPUT_LAYOUT_DESC CObjectsShader::CreateInputLayout()
{
	...
	pd3dInputElementDescs[1] = { "COLOR", 0, DXGI_FORMAT_R32G32B32A32_FLOAT, 0, 12,
	D3D12_INPUT_CLASSIFICATION_PER_VERTEX_DATA, 0 };
	/*pd3dInputElementDescs[1] = { "COLOR", 0, DXGI_FORMAT(8), 0, 12,
	D3D12_INPUT_CLASSIFICATION_PER_VERTEX_DATA, 0 };*/
	D3D12_INPUT_LAYOUT_DESC d3dInputLayoutDesc;
	d3dInputLayoutDesc.pInputElementDescs = pd3dInputElementDescs;
	d3dInputLayoutDesc.NumElements = nInputElementDescs;
...
void CObjectsShader::BuildObjects(ID3D12Device* pd3dDevice, ID3D12GraphicsCommandList* pd3dCommandList, void* pContext)
{
	...
	CCubeMeshDiffused* pCubeMesh = new CCubeMeshDiffused(pd3dDevice, pd3dCommandList, 100.0f, 100.0f, 100.0f);
	//
	...
	//m_ppObjects[0]->pRotatingObject = NULL;
	//
	...
	/*pRotatingObject->m_xmf4x4World._41 = pTerrain->GetWidth();
	pRotatingObject->m_xmf4x4World._42 = 1500;
	pRotatingObject->m_xmf4x4World._43 = pTerrain->GetLength();*/

	/*pRotatingObject->SetPosition(pTerrain->GetWidth(), 1500, pTerrain->GetLength());
	cout << pTerrain->GetWidth() << endl;
	cout << 1500 << endl;
	cout << pTerrain->GetLength() << endl;*/
	//22.06.18
	//pl->m_ppObjects[0]->updatePlayer(pTerrain->GetWidth(), 1500, pTerrain->GetLength());
		//
	...
	pRotatingObject->SetRotationSpeed(36.0f * (1 % 10) + 36.0f);
...
/*CCubeMeshDiffused* pCubeMesh = new CCubeMeshDiffused(pd3dDevice, pd3dCommandList, 12.0f, 12.0f, 12.0f);
CRotatingObject* badGuy = NULL;
badGuy = new CRotatingObject(1);
badGuy->SetMesh(0, pCubeMesh);
badGuy->SetPosition(100, 1500,0);
badGuy->SetRotationAxis(XMFLOAT3(0.0f, 1.0f, 0.0f));
badGuy->SetRotationSpeed(36.0f * (m_nObjects % 10) + 36.0f);
obj = badGuy;*/
//
...
{
	/*if (1 == pl->toTheBattlefield)
		pl->SetPosition(XMFLOAT3(pl->m_ppObjects[0]->m_xmf4x4World._41, pl->m_ppObjects[0]->m_xmf4x4World._42, pl->m_ppObjects[0]->m_xmf4x4World._43));*/
...
void CObjectsShader::Render(ID3D12GraphicsCommandList* pd3dCommandList, CCamera* pCamera)
{
	...
	/*for (int j = 0; j < m_nObjects; j++)
	{*/
	if (m_ppObjects[m_nObjects - 1])
	{
		m_ppObjects[m_nObjects - 1]->Render(pd3dCommandList, pCamera);
	}
	//}
...
//XMFLOAT3 CObjectsShader::getPosition()
//{
//	m_ppObjects[0]->updatdPlayer = m_ppObjects[0]->GetPosition();
