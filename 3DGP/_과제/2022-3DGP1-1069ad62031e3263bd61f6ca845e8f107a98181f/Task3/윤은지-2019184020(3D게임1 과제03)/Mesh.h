...
{
public:
	CAirplaneMeshDiffused(XMFLOAT4 color, ID3D12Device* pd3dDevice, ID3D12GraphicsCommandList
	...
	//22.06.18
	//플레이어 색깔
	XMFLOAT4 xmf4Color;// = XMFLOAT4(0.0f, 1.0f, 0.0f, 0.0f);
	void setColor();
	int planeColor = 0;
	//
};
...
{
protected:
	//격자의 크기(가로: x-방향, 세로: z-방향)이다. int m_nWidth;
	int m_nLength;
	int m_nWidth;
