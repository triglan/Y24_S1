...
void CPlayer::Move(DWORD dwDirection, float fDistance, bool bUpdateVelocity)
{
	if (dwDirection)
	{
		...
		//	//if (m_xmf3Position.x >= -160 && m_xmf3Position.x < -90)
		//	//	//SetPosition(-60.f, m_xmf3Position.y, m_xmf3Position.z);
		//	//	track = 1;

		//	//else if (m_xmf3Position.x >= -90 && m_xmf3Position.x < -30)
		//	//	//SetPosition(0.f, m_xmf3Position.y, m_xmf3Position.z);
		//	//	track = 2;

		//	if (true == goRight && m_xmf3Position.x >= -30 && m_xmf3Position.x < 30)
		//	{
		//		//SetPosition(60.f, m_xmf3Position.y, m_xmf3Position.z);
		...
		//		//SetPosition(60.f, GetPosition().y, GetPosition().z);
		//	}

		//	else if (true == goRight && m_xmf3Position.x >= 30 && m_xmf3Position.x < 90)
		//	{
		//		//SetPosition(120.f, m_xmf3Position.y, m_xmf3Position.z);
		//		/*Move(xmf3Shift, bUpdateVelocity);
		//		return;*/
		//		track = 4;
		//		goRight = FALSE;
		//		//SetPosition(120.f, GetPosition().y, GetPosition().z);
		//	}

		//	//else //if (m_xmf3Position.x >= 90 && m_xmf3Position.x < 160)
...
CAirplanePlayer::CAirplanePlayer(ID3D12Device* pd3dDevice, ID3D12GraphicsCommandList* pd3dCommandList, ID3D12RootSignature* pd3dGraphicsRootSignature)
{
	...
	//	CGameObject *pGameObject = CGameObject::LoadGeometryFromFile(pd3dDevice, pd3dCommandList, pd3dGraphicsRootSignature, "Model/Apache.bin");
		//22.05.25
	CGameObject* pGameObject = CGameObject::LoadGeometryFromFile(pd3dDevice, pd3dCommandList, pd3dGraphicsRootSignature, "Models/Hummer.bin");
	//
