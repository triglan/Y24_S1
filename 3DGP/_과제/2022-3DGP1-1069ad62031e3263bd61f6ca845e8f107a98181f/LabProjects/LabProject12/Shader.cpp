...
D3D12_SHADER_BYTECODE CShader::CompileShaderFromFile(const WCHAR* pszFileName, LPCSTR pszShaderName, LPCSTR pszShaderProfile, ID3DBlob** ppd3dShaderBlob)
{
	...
	//cout << ㅠ << endl;
	//compilationMsgs Blob
	/*if (FAILED(ㅠ))
		MessageBox(0, L"Failed D3DCompileFromFile", 0, 0);*/
	 
	//D3D_COMPILER_VERSION < 46
	//cout << *ppd3dShaderBlob << endl;
	/*ID3DBlob* pd3dErrorBlob = NULL;
	HRESULT ㅠ
=	::D3DCompileFromFile(pszFileName, NULL, D3D_COMPILE_STANDARD_FILE_INCLUDE, pszShaderName, pszShaderProfile, nCompileFlags, 0, &m_pd3dVertexShaderBlob, &pd3dErrorBlob);*/

	//cout << boolalpha<<ㅠ << endl;

	//::D3DCompileFromFile(pszFileName, NULL, D3D_COMPILE_STANDARD_FILE_INCLUDE, pszShaderName, pszShaderProfile, nCompileFlags, 0, ppd3dShaderBlob, &pd3dErrorBlob);
	//::D3DCompileFromFile(pszFileName, NULL, D3D_COMPILE_STANDARD_FILE_INCLUDE, pszShaderName, pszShaderProfile, nCompileFlags, 0, ppd3dShaderBlob, &pd3dErrorBlob);
	/*char* pErrorString = NULL;
	if (pd3dErrorBlob) pErrorString = (char*)pd3dErrorBlob->GetBufferPointer();
	cout << endl<<endl<<pErrorString << endl;*/
...
{
	//return(CShader::CompileShaderFromFile(L"Shaders.hlsl", "PSDiffused", "ps_5_1", &m_pd3dVertexShaderBlob));
