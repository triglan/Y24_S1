...
void CScene::BuildObjects()
{
	...
	//pGameObject->SetMesh(new CCubeMesh(4.0f, 4.0f, 4.0f));
	
	
	//CCubeMesh* pCubeMesh = new CCubeMesh(4.0f, 4.0f, 4.0f);
	CAirplaneMesh* pCubeMesh = new CAirplaneMesh(4.0f, 4.0f, 4.0f / 5.f);

	m_nObjects = 11;
	m_ppObjects = new CGameObject * [m_nObjects];
	CCubeMesh* pCubeMesh2 = new CCubeMesh(6.0f, 6.0f, 6.0f);
	m_pShieldObject = new CShield;
	m_pShieldObject->SetMesh(pCubeMesh2);
	m_pShieldObject->SetColor(RGB(255, 255, 0));
	...
	XMFLOAT3 xf1(0,-1,0);
	XMFLOAT3 xf2(0, 0, 1);
	pExplosiveObject->LookTo(xf1, xf2);
	...
	pExplosiveObject = new CExplosiveObject();
	//pExplosiveObject->SetMesh(pCubeMesh2);
...
void CScene::Animate(float fElapsedTime)
{
	...
	m_pShieldObject->SetPosition(pos.x, pos.y, pos.z);
